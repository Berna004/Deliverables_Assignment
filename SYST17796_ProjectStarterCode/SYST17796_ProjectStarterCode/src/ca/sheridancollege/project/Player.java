 ...
 * Provides methods to add a card to the player's hand, calculate the total value of the hand,
 * and check if the player's hand has gone bust (over 21).
 *
 * @author dancye
 * @author Paul Bonenfant Jan 2020
 * @author Bernardo Coelho, August 14 2023
 */
public class Player {
